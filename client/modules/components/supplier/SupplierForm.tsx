"use client"
import { SupplierInput, supplierSchema } from "@/modules/product/product.schema";
    ...
    return(
        <div>
            ...
            <form onSubmit={handleSubmit((data:any)=>onSubmit(data))}>
                ...
                <input type='text'{...register('contactPerson')} placeholder="Contact Person" />
                <input type='text'{...register('contactPersonPhone')} placeholder="Contact Person Phone" />
                <input type='text' {...register('gst')} placeholder="GST" />
                <button type="submit" disabled={isLoading}>{isLoading ? "Submitting..." : "Submit"}</button>
                <button type="button" onClick={() => router.back()} disabled={isLoading}>Cancel</button>
            </form>
        </div>
    )
}
