...
import { useCategories, useDeleteCategory } from "@/modules/hooks/useCategory";
...
export default function CategoryPage(){
    ...
    return(
        <div>
            <PageHeader title="Category" createHref="/dashboard/category/create" createLabel="Add Category"/>
          <div className="bg-gray-800 rounded-xl shadow overflow-hidden border border-gray-700">
            ...
            isError? (<ErrorState message="Error loading categories"/>):!categories?.length? (<EmptyState message="No categories found"/>):(
                      ...
                      <tr key={category.id} className="hover:bg-gray-700/30 transition-colors">
                        ...
                        <td className="p-4">
                          <RowActions
                            ...
                            isDeleting={deleteMutation.isPending && confirmId === category.id}
                          />
                        </td>
                      </tr>
                    ))}
